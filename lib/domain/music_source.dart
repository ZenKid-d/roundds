...
abstract class MusicSource {
  ...
  /// Поиск треков по запросу. [page] — номер страницы (0 — первая) для
  /// подгрузки следующей порции при долистывании списка результатов; смысл
  /// определяет сама реализация (реальный offset у SoundCloud/VK, page у
  /// Яндекса). Источники без поддержки постраничной выдачи (см. YouTube)
  /// параметр игнорируют и при page > 0 возвращают тот же первый результат —
